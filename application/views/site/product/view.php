...
$(document).ready(function(){
    ...
    var an_di=$('a.selected').attr('rel');//láº¥y title cá»§a tháº» <a class='active'>
    $('div#'+an_di).hide();//áº©n tháº» <div id='an_di'>
    $('a.selected').removeClass('selected');
    $(this).addClass('selected');
    var hien_thi=$(this).attr('rel');//láº¥y title cá»§a tháº» <a> khi ta kick vÃ o nÃ³
    $('div#'+hien_thi).show();//hiá»‡n lÃªn tháº» <div id='hien_thi'>
    });
});
</script> 
...
<!-- AddThis Button END -->
		            ...
		            <table width="100%" cellspacing="0" cellpadding="3" border="0" class="tbsicons">
					           ...
					           <tr>
					                    ...
					                    <td width="25%"><img alt="Giao hàng trong 24h" src="<?php echo public_url('site')?>/images/icon-delivery.png"> <div>Giao hàng trong 24h</div></td>
					           </tr>
					          </tbody>
					</table>
		      </div>
...
<div class="usual" id="usual1">
     <ul>
	       <li><a title="Chi tiáº¿t sáº£n pháº©m" rel='tab2' href='javascript:void(0)' class="tab selected">Chi tiết sản phẩm</a></li>
	       <li><a title="Video" rel='tab3' href='javascript:void(0)' class="tab">Video</a></li> 
	       <?php /*?>
	       <li><a title="Há»�i Ä‘Ã¡p vá»� sáº£n pháº©m" rel='tab4' href='javascript:void(0)' class="tab">Há»�i Ä‘Ã¡p vá»� sáº£n pháº©m</a></li> 
	       <?php */?>        
	</ul>
