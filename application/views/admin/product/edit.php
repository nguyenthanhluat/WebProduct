...
<div class="formRow">
	...
	<div class="formRight">
		<span class="oneTwo">
			...
			<img src="<?php echo public_url('admin')?>/crown/images/icons/notifications/information.png" style="margin-bottom:-8px" class="tipS" original-title="GiÃ¡ bÃ¡n sá»­ dá»¥ng Ä‘á»ƒ giao dá»‹ch">
		</span>
...
<div class="formRow">
	...
	<div class="formRight">
		<span>
			...
			<img src="<?php echo public_url('admin')?>/crown/images/icons/notifications/information.png" style="margin-bottom:-8px" class="tipS" original-title="Sá»‘ tiá»�n giáº£m giáº£m giÃ¡">
		</span>
