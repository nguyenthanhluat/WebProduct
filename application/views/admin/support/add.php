...
<div class="wrapper">
      <div class="widget">
           <div class="title">
			<h6>Thêm mới hỗ trợ khách hàng</h6>
		</div>
      ...
      <form id="form" class="form" enctype="multipart/form-data" method="post" action="">
          <fieldset>
				...
				<div class="formRow">
                	...
                	<div class="formRight">
                		<span class="oneTwo"><input type="text" _autocheck="true" id="param_yahoo" value="<?php echo set_value('yahoo')?>" name="yahoo"></span>
				...
				<div class="formRow">
                	...
                	<div class="formRight">
                		<span class="oneTwo"><input type="text" _autocheck="true" id="param_gmail" value="<?php echo set_value('gmail')?>" name="gmail"></span>
				...
				<div class="formRow">
                	...
                	<div class="formRight">
                		<span class="oneTwo"><input type="text" _autocheck="true" id="param_skype" value="<?php echo set_value('skype')?>" name="skype"></span>
