...
Class News extends MY_Controller
{
    ...
    function index()
    {
        ...
        $config = array();
        $config['total_rows'] = $total_rows;//tong tat ca cac bai viet tren website
        $config['base_url']   = admin_url('news/index'); //link hien thi ra danh sach bai viet
        $config['per_page']   = 5;//so luong bai viet hien thi tren 1 trang
    ...
    function edit()
    {
        ...
        if(!$news)
        {
            $this->session->set_flashdata('message', 'khong tồn tại bài viết này');
            redirect(admin_url('news'));
        }
        $this->data['news'] = $news;
